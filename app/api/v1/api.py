...
api_router.include_router(admin_dashboard_api.router, prefix="/admin", tags=["Admin Dashboard"])
...
api_router.include_router(generate_recipe_api.router, prefix="/generate_recipe", tags=["Recipe Generator"])
